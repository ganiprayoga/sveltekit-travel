<script context="module">
	...
	import {dateFormat} from "$lib/constant.js";
...
<script>
	...
	onMount(async () => {
		try {
			...
			loaded = true;
			await loadGuide(trip.array_options.options_f_tour_leader);
		} catch (err) {
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{`${dateFormat(trip.date_start)} - ${dateFormat(trip.date_end)}`}</dd>
                        </div>
<!--                        <div class="sm:col-span-1">-->
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            <DetailItinerary detailed={true} {tripID}/>
                        </div>
                    </dl>
                </div>
            </div>
